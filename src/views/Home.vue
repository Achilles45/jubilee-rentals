<template>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 slide-img" src="../assets/slider-1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 slide-img" src="../assets/slider-2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 slide-img" src="../assets/slider-4.jpg" alt="Third slide">
    </div>
  </div>
    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-12">
          ...
          <p>When we say that we are your partner of choice in making you have the event or party of your dreams, we actually mean it. Beyond just helping you plan your weddings, dinner parties, graduation, family reunion, birthday parties, special ceremonies, or corporate events, we provide you with a broad range of rental products from classy tables, chairs, party tents, dinnerwares, decoration essentials, mist fan, Uhaul van, to catering equipments and any other material needed to make your event a success. We constantly strive to provide you with the highest level of customer support. We are your one-stop shop for all your events. Try us today!</p>
        </div>
      </div>
    </div>
  </section> 
  ...
  <!--Why us
  ========================-->
  <section class="why__us container-fluid">
    <div class="container">
      <div class="row text-center">
        <div class="col-12">
          <h2>Why you should consider us</h2>
        </div>
      </div>
      <div class="why__us--contents">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <p>We put all factors into consideration from the type and location of the venue, lightings and others, so we can then guide you on the choice of colors, linens and other materials to use based on these conditions.</p>
        ...
        <div class="col-md-6 service-img">
          <img src="../assets/celebrate2.jpg" class="img-fluid" alt=""><br /><br />
           <p>Jubilee Rentals and Decor is 100% customer centric. Your satisfaction is what matters to us. We therefore work very hard to make sure your guest have a wonderful experience while they celebrate with you. Give us a try today!</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <!--Planning section
  =======================-->
  <section class="planning container-fluid">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <img src="../assets/celebrate.jpg" class="img-fluid" alt="">
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <p>Stay in the loop with the latest news, products and inspirational ideas for your next event. We promise you won't be spammed.</p>
        </div>
